...
- Minecraft Speedrunner (PB: 13:10), Speedcuber (PB: 10.89s)
- Obsesses over his favourite Music Albums

#### Stuff I Built

- [ClubzFM](https://clubz.fm) (Full Stack Developer Intern)

Helped build ClubzFM from 0 to 1 as an early full-stack intern, doing over **500,000 fan interactions** and over **Rs. 1,000,000 in generated revenue**. Built tooling to allow **Outstation to engage 150K+ fans** and a Dhanji giveaway being **claimed in under 54 seconds**.

- [PaceMan.gg Mobile App](https://github.com/PaceMan-MCSR/Mobile-App) (Mobile App + Backend Microservice)

Real-time Minecraft Speedrun pace tracker mobile app, built on top of PaceMan.gg's tooling. **5.0-Star Rating** across both platforms. **150,000-200,000 notifications/month** organically.
